  ...
  <div>
    ...
    <section id="placement" className="mb-5">
      ...
      <p className="mt-2">
        ...
        values are at the: top, top left, top right, top start, top end, bottom,
        bottom left, bottom right, bottom start, bottom end, left, left top,
        left bottom, start, start top, start bottom, right, right top, right
    ...
    <section id="icons" className="mb-5">
      ...
      <div className="row align-items-center">
        <p className="mt-2">
          Icons are not always easy to identify on their own. When you use
          components that don’t have labels — for example, icon-only action
          buttons and tabs — make sure to use tooltips to provide context for
          the icons.
        </p>
        <div className="col-md-6">
