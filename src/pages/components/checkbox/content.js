...
const Content = () => (
  <div>
    ...
    <section id="anatomy" className="mb-5">
      ...
      <p>Checkboxes can stand alone, be grouped, or nested.</p>
    </section>

    <section id="appearance" className="mb-5">
      <h2>Layout and spacing</h2>
      <p className="mt-3">
        The checkbox component layout and spacing ensure consistent and balanced
    ...
    <section id="variation" className="mb-5">
      ...
      <div className="mt-3">
        <ul className="ps-3">
          <li>
            Checkbox components exhibit several interaction states: enabled,
          ...
          <li>
            Default configurations determine how checkboxes appear: checked,
            unchecked, or disabled. Notably, checkboxes must enable actions that
            users can undo by simply unchecking the box, ensuring reversible
            choices. For instance, checkboxes are suitable for filters but
            unsuitable for deletions. To incorporate actions, consider utilizing
            Button Status.
          </li>
        </ul>
    ...
    <section id="guidelines" className="mb-5">
      ...
      <div className="mt-3">
        <ul className="ps-3">
          <li>Ensure a label is consistently provided.</li>
          <li>Employ sentence case for label text.</li>
          <li>
          ...
          <li>
            Frame labels as affirmations in the checked state and negations in
            the unchecked state.
          </li>
          <li>
            Title a checkbox collection when its content isn't instantly clear.
          </li>
          <li>Enable both checkbox and label for selection.</li>
        </ul>
      </div>
