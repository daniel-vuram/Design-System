      ...
      <div className="row">
        ...
        <div className="col-xxl-4">
          ...
          >
            ...
            <li>
              <a href="#style_guide">Style Guide to designing ID cards</a>
            </li>
            <li>
              <a href="#step_by_step">Step by step guide for ID card design</a>
            </li>
            <li>
              <a href="#guidelines">Guidelines for designing ID card</a>
            </li>
          </Scrollspy>
        </div>
      </div>
