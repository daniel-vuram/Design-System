...
const Content = () => (
  <div>
    ...
    <section id="guidelines" className="mb-5">
      ...
      <ol>
        <li>
          Maintain Consistency: Ensure that all design elements, fonts, colors,
          and branding adhere to workhall’s design standards.
        </li>
        <li>
          Use Clear Typography: Use only inter font and maintain consistent font
          styles and sizes, and allow for proper spacing.{" "}
        </li>
        <li>
        ...
        <li>
          Follow Colour Palette: Stick to Workhall’s colour palette to maintain
          a professional and harmonious look
        </li>
        <li>
        ...
        <li>
          Present Data Effectively: Employ clear charts, graphs, and tables with
          proper labelling and titles for data presentations.
        </li>
        <li>
        ...
        <li>
          Maintain Readability: Keep text concise, avoid lengthy paragraphs, and
          use readable fonts.
        </li>
        <li>
          Use White Space: Allow for adequate white space to reduce clutter and
      ...
      <ol>
        <li>
          Overcomplicate Design: Avoid overly complex or cluttered designs that
        ...
        <li>
          Use Unreadable Fonts:Stay away from fonts that are difficult to read,
        ...
        <li>
          Neglect Content Hierarchy: Do not create slides with equal emphasis on
          all elements; prioritise the main message.
        </li>
        <li>
        ...
        <li>
          Overuse Transitions and Animations: Avoid excessive slide transitions
          and animations that can distract or become tiresome.
        </li>
        <li>
          Present Dense Text: Do not overwhelm slides with lengthy paragraphs of
          text.
        </li>
        <li>
          Overcrowd with Elements:Maintain proper spacing and avoid cramming too
          many elements onto one slide.
        </li>
        <li>
